...
router.get('/users/:userId(\\d+)/subscription', (req, res) => {
  userSubscriptionService.getUserSubscription(req.params.userId)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
...
router.post('/users/:userId(\\d+)/subscription', (req, res) => {
  userSubscriptionService.create(req.params.userId, req.body)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
...
router.delete('/users/:userId(\\d+)/subscription', (req, res) => {
  userSubscriptionService.destroy(req.params.userId)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
