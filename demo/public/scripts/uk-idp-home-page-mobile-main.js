...
(function () {
  $(function () {
    ...
    var $applyBanner = $('.apply-banner');
    var navBarOffsetTop = $navs.offset().top;
    var scrollTopAnchorOffset = $('.scroll-top-anchor').offset().top;
    ...
    $.getJSON(API_BASE_URL + '/companies/university_tour').done(function (result) {
      console.log(result);
      if (!result || result.length <= 0) {
        return;
      }
      var otherCompanies = result.filter(function (company) {
        return company.id != 19051 && company.id != 3155 && company.id != 9262;
      });
      var $otherCompanies = $('#otherCompanies');
      var $companyTemplate = $otherCompanies.find('.company');
      otherCompanies.forEach(function (company) {
        var $company = $companyTemplate.clone();
    ...
    function wxShare() {
      ...
      var link = void 0;
      var title = '2018环英校招嘉年华';
      var desc = '名校环英30天，走进15余所顶尖名校，宣讲企业文化，精选名企职位投递，直达HR邮箱';
      var imgUrl = '/images/university-tour/careerfrog-logo.jpg';
