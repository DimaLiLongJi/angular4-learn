...
// }
var btn = document.getElementById('apply-link');
var list = document.getElementById('email-list');
var goBackBtn = document.getElementById('go-back-btn');
var goHistoryBtn = document.getElementById('go-history-btn');
...
function checkAvailable() {
  if (USER && USER.id) {
    $.getJSON('/api/users/' + USER.id + '/applications/' + oppId + '/available?t=' + new Date(), function (result) {
...
(function () {
  ...
  var shareImage = 'http://static.careerfrog.com.cn/cf-college/images/recruit-share.e8cf3cad.jpg';
  var link = void 0;
  var title = void 0;
  var desc = void 0;
  var imgUrl = void 0;

  opp.desc = opp.description.replace(/\n/g, '').replace(/&amp;/g, '&').replace(/&nbsp;/g, '').replace(/\s/g, '').replace(/<\/?[^>]*>/g, '').trim().substr(0, 200) + '\u2026\u2026';
  ...
  function reConfig() {
    ...
    desc = opp.desc;
    imgUrl = /default/.test(opp.companyDetail.imageUrl) ? 'http://static.careerfrog.com.cn/cf-college/images/share.06b6e3ab.jpg' : opp.companyDetail.imageUrl;
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jQuery"] = __webpack_require__(281);
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(282);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(14)))
