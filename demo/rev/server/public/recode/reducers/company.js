...
function randomBg() {
  if (Math.random() > 0.5) {
    return "url('http://static.careerfrog.com.cn/cf-college/images/banner-company.c7940d5a.jpg')";
  } else {
    return "url('http://static.careerfrog.com.cn/cf-college/images/banner-company2.f39f1ae0.jpg')";
  }
}