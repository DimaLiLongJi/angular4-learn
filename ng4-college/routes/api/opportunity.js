...
router.get('/opportunities/customize', (req, res) => {
  ...
  opportunityService.getCustomizedOpportunityList(params)
    .then((result) => {
      res.json(result);
    })
    .catch((error) => {
...
router.get('/opportunities/count', (req, res) => {
  const params = req.query || {};
  opportunityService.getOpportunityCount(params)
    .then((result) => {
      res.json(result);
    })
    .catch((error) => {
...
router.get('/opportunities/statistics/industry', (req, res) => {
  const params = req.query;
  opportunityService.getIndustryStatistics(params)
...
router.get('/opportunities/:id(\\d+)', (req, res) => {
  ...
  return opportunityService.getDetail(params)
    .then((opp) => {
      res.send(opp);
    });
});
...
router.get('/opportunities/location/list', (req, res) => {
  ...
  opportunityService.getLocationList(params)
    .then((result) => {
      res.json(result);
    });
});
...
router.get('/campus_recruits/companies/statistics', (req, res) => {
  opportunityService.getCompanyStatistics(req.query)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
...
router.get('/campus_recruits/companies', (req, res) => {
  opportunityService.getRecruitCompanyList(req.query)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
...
router.get('/campus_recruits/companies/:companyId(\\d+)/opportunities', (req, res) => {
  opportunityService.getCompanyCampusOpportunities(req.params.companyId)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
...
router.get('/campus_recruits/recommend/:id(\\d+)', (req, res) => {
  opportunityService.getCampusRecruitRecommend(req.params.id)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
...
router.get('/campus_recruits/countdown_list', (req, res) => {
  opportunityService.getRecruitCountdown(req.query)
    .then((result) => {
      res.json(result);
    })
    .catch((err) => {
