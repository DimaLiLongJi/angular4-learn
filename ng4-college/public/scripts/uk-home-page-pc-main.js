...
(function () {
  $(function () {
    ...
    var applyLink = 'https://jinshuju.net/f/yo1yLB';
    if (_jsCookie2.default.get('x_field_1')) {
      applyLink += '?x_field_1=' + _jsCookie2.default.get('x_field_1');
    }

    $('#toolbar').attr('href', applyLink);
    $('#qr-chat-icon').attr('href', applyLink);
    $('#apply-now').attr('href', applyLink);
    $.getJSON(API_BASE_URL + '/companies/university_tour', function (result) {
